 							...
 							try {
 								...
 								if (l18 > 0 || i19 > 0) {
 									...
 									if (i19 == 0) {
 										...
 										//System.out.println("Overlay: (HSL: "+ j23+"), (Texture: "+i23 +"), (RGB: " +k23 + "), Floor: "+floorId);
...
label0:
    ...
    public void method175(int y, WorldController worldController, Class11 class11, int j, int z, int x, int i1, int j1) {
		...
		int l2 = x + (y << 7) + ((i1 > 32000 ? 0 : i1) << 14) + 0x40000000;
		...
		if (j == 22) {
			...
			worldController.method280(z, k2, y, ((Animable) (obj)), byte0, l2, x);
		...
		if (j == 10 || j == 11) {
			...
			if (obj1 != null) {
				...
				if (worldController.method284(l2, byte0, k2, l4, ((Animable) (obj1)), j4, z, i5, y, x) && class46.aBoolean779) {
					Model model;
		...
		if (j >= 12) {
			...
			worldController.method284(l2, byte0, k2, 1, ((Animable) (obj2)), 1, z, 0, y, x);
		...
		if (j == 0) {
			...
			worldController.method282(anIntArray152[j1], ((Animable) (obj3)), l2, y, byte0, x, null, k2, 0, z);
			if (j1 == 0) {
		...
		if (j == 1) {
			...
			worldController.method282(anIntArray140[j1], ((Animable) (obj4)), l2, y, byte0, x, null, k2, 0, z);
			if (class46.aBoolean779)
				if (j1 == 0)
					aByteArrayArrayArray134[z][x][y + 1] = 50;
				else if (j1 == 1)
		...
		if (j == 2) {
			...
			worldController.method282(anIntArray152[j1], ((Animable) (obj11)), l2, y, byte0, x, ((Animable) (obj12)), k2, anIntArray152[i3], z);
			if (class46.aBoolean764)
				if (j1 == 0) {
					anIntArrayArrayArray135[z][x][y] |= 0x249;
					anIntArrayArrayArray135[z][x][y + 1] |= 0x492;
		...
		if (j == 3) {
			...
			worldController.method282(anIntArray140[j1], ((Animable) (obj5)), l2, y, byte0, x, null, k2, 0, z);
			if (class46.aBoolean779)
				if (j1 == 0)
					aByteArrayArrayArray134[z][x][y + 1] = 50;
				else if (j1 == 1)
		...
		if (j == 9) {
			...
			worldController.method284(l2, byte0, k2, 1, ((Animable) (obj6)), 1, z, 0, y, x);
			if (class46.aBoolean767 && class11 != null)
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, x, y, j1);
			return;
		}
