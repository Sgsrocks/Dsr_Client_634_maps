...
public final class RSInterface {
	...
	public static void addGenericTooltip(int id, int height, int width, String message) {
...
public static void addGenericTabTooltip(int id, int height, int width, String message) {
		RSInterface hover = addInterface(id);
		hover.type = 8;
		hover.message = message;
		hover.height = height;
    ...
    public static void SquealOfFortune(TextDrawingArea atextdrawingarea[])
    {
        ...
        addText(48508, "0", 0xe3cccf, true, true, 52, 2);
...
setBounds(3826, 60, 85, 6, rsinterface);
	 ...
	 public static TextDrawingArea[] fonts;
		...
		public static void addHovers() {
			/**Prayer Interface**/
				addPrayerTooltip(25052, "Level 01\\nThick Skin\\nIncreases your Defence by 5%");
				addPrayerTooltip(25054, "Level 04\\nBurst of Strength\\nIncreases your Strength by 5%");
				addPrayerTooltip(25056, "Level 07\\nClarity of Thought\\nIncreases your Attack by 5%");
				addPrayerTooltip(25058, "Level 08\\nSharp Eye\\nIncreases your Ranged by 5%");
				addPrayerTooltip(25060, "Level 09\\nMystic Will\\nIncreases your Magic by 5%");
				addPrayerTooltip(25062, "Level 10\\nRock Skin\\nIncreases your Defence by 10%");
				addPrayerTooltip(25064, "Level 13\\nSuperhuman Strength\\nIncreases your Strength by 10%");
				addPrayerTooltip(25066, "Level 16\\nImproved Reflexes\\nIncreases your Attack by 10%");
				addPrayerTooltip(25068, "Level 19\\nRapid Restore\\n2x restore rate for all stats\\nexcept Hitpoints, Summoning\\nand Prayer");
				addPrayerTooltip(25070, "Level 22\\nRapid Heal\\n2x restore rate for the\\nHitpoints stat");
				addPrayerTooltip(25072, "Level 25\\nProtect Item\\nKeep 1 extra item if you die");					
				addPrayerTooltip(25074, "Level 26\\nHawk Eye\\nIncreases your Ranged by 10%");
				addPrayerTooltip(25076, "Level 27\\nMystic Lore\\nIncreases your Magic by 10%");
				addPrayerTooltip(25078, "Level 28\\nSteel Skin\\nIncreases your Defence by 15%");
				addPrayerTooltip(25080, "Level 31\\nUltimate Strength\\nIncreases your Strength by 15%");
				addPrayerTooltip(25082, "Level 34\\nIncredible Reflexes\\nIncreases your Attack by 15%");					
				addPrayerTooltip(25084, "Level 37\\nProtect from Magic\\nProtection from magical attacks");
				addPrayerTooltip(25086, "Level 40\\nProtect from Missles\\nProtection from ranged attacks");
				addPrayerTooltip(25088, "Level 43\\nProtect from Melee\\nProtection from melee attacks");					
				addPrayerTooltip(25090, "Level 44\\nEagle Eye\\nIncreases your Ranged by 15%");
				addPrayerTooltip(25092, "Level 45\\nMystic Might\\nIncreases your Magic by 15%");
				addPrayerTooltip(25094, "Level 46\\nRetribution\\nInflicts damage to nearby\\ntargets if you die");
				addPrayerTooltip(25096, "Level 49\\nRedemption\\nHeals you when damaged\\nand Hitpoints falls\\nbelow 10%");
				addPrayerTooltip(25098, "Level 52\\nSmite\\n1/4 of damage dealt is\\nalso removed from\\nopponent's Prayer");
				addPrayerTooltip(25100, "Level 60\\nChivalry\\nIncreases your Defence by 20%,\\nStrength by 18%, and Attack by\\n15%");
				addPrayerTooltip(25102, "Level 70\\nPiety\\nIncreases your Defence by 25%,\\nStrength by 23%, and Attack by\\n20%");		
	...
	public static void Bank(TextDrawingArea[] wid){
		...
		addBankHover1(22020, 5, 22021, 21, "Bank/BANK", 35, 25, "Deposit money in Vault.", 22022, 22, "Bank/BANK", 22023, "Empty your BoB's inventory\ninto your bank", 0, 20);
	...
	public static void unpack(StreamLoader streamLoader, TextDrawingArea textDrawingAreas[], StreamLoader streamLoader_1) {
		...
		while(stream.currentOffset < stream.buffer.length) {
			...
			if(rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll("RuneScape", "Death Scape Reborn");
       ...
       // scrollCreation(textDrawingAreas);//BUGGED
