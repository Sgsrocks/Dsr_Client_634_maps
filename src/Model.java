...
public class Model extends Animable {
	...
	public final void method482(int j, int k, int l, int i1, int j1, int k1) {
		...
		int j4 = j1 * l3 + k1 * i4 >> 16;
			...
			if(Constants.enableDepthBuffer)
				vertexPerspectiveZB[k4] = 0;
	...
	public final void method443(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int id) {
		int j2 = l1 * i1 - j1 * l >> 16;
		int k2 = k1 * j + j2 * k >> 16;
		int l2 = anInt1650 * k >> 16;
		int i3 = k2 + l2;
	...
	private final void method483(boolean flag, boolean needAddToSelectedObjects, int i, int id) {
		for (int j = 0; j < anInt1652; j++)
			anIntArray1671[j] = 0;

		//filterTriangles();
		for (int triangleId = 0; triangleId < anInt1630; triangleId++) {
			if (anIntArray1637 != null && anIntArray1637[triangleId] == -1
					|| anIntArray1639 != null && anIntArray1639[triangleId] >= 255)
				continue;
			...
			if (flag && (vertexXA == -5000 || vertexXB == -5000 || vertexXC == -5000)) {
				...
				int j5 = (anIntArray1667[face_a_pos] + anIntArray1667[face_b_pos] + anIntArray1667[face_c_pos])
						/ 3 + anInt1653;
				anIntArrayArray1672[j5][anIntArray1671[j5]++] = triangleId;
				continue;
			}
			if (needAddToSelectedObjects
					&& method486(anInt1685, anInt1686,
							anIntArray1666[face_a_pos], anIntArray1666[face_b_pos],
							anIntArray1666[face_c_pos], vertexXA, vertexXB, vertexXC)) {
				mapObjectIds[anInt1687] = id;
			...
			if ((vertexXA - vertexXB) * (anIntArray1666[face_c_pos] - anIntArray1666[face_b_pos])
				...
				aBooleanArray1663[triangleId] = vertexXA < 0 || vertexXB < 0 || vertexXC < 0
						|| vertexXA > DrawingArea.centerX || vertexXB > DrawingArea.centerX
						|| vertexXC > DrawingArea.centerX;
				int k5 = (anIntArray1667[face_a_pos] + anIntArray1667[face_b_pos] + anIntArray1667[face_c_pos])
						/ 3 + anInt1653;
				anIntArrayArray1672[k5][anIntArray1671[k5]++] = triangleId;
			}
		}
		...
		if (i1 == 0) {
			if(Constants.enableDepthBuffer)
				Texture.drawShadedTriangle(anIntArray1666[j], anIntArray1666[k],
					...
					anIntArray1636[i], vertexPerspectiveZB[j], vertexPerspectiveZB[k], vertexPerspectiveZB[l]);
			else
		...
		if (i1 == 1) {
			if(Constants.enableDepthBuffer)
				Texture.drawFlatTriangle(anIntArray1666[j], anIntArray1666[k],
					anIntArray1666[l], anIntArray1665[j], anIntArray1665[k],
					anIntArray1665[l], modelIntArray3[anIntArray1634[i]], vertexPerspectiveZB[j], vertexPerspectiveZB[k], vertexPerspectiveZB[l]);
			else
		...
		if (i1 == 2) {
			...
			if(Constants.enableDepthBuffer)
				Texture.drawTexturedTriangle(anIntArray1666[j], anIntArray1666[k],
					...
					anIntArray1670[l2], anIntArray1640[i], vertexPerspectiveZB[j], vertexPerspectiveZB[k], vertexPerspectiveZB[l]);
			else
			...
			int k1 = anIntArray1637[i] >> 2;
				...
				if(Constants.enableDepthBuffer)
					Texture.drawTexturedTriangle(anIntArray1666[j], anIntArray1666[k],
						...
						anIntArray1670[i3], anIntArray1640[i], vertexPerspectiveZB[j], vertexPerspectiveZB[k], vertexPerspectiveZB[l]);
				else
				Texture.method378(anIntArray1666[j], anIntArray1666[k],
						anIntArray1666[l], anIntArray1665[j], anIntArray1665[k],
						anIntArray1665[l], anIntArray1634[i], anIntArray1634[i],
				...
				if (l7 == 0)
					...
					if(Constants.enableDepthBuffer)
						Texture.drawTexturedTriangle(i7, j7, k7, j3, j4, j5,
							...
							anIntArray1640[i], vertexPerspectiveZB[i1], vertexPerspectiveZB[j1], vertexPerspectiveZB[k1]);
					else
			...
			if (l == 4) {
				...
				if (i8 == 0) {
					if(Constants.enableDepthBuffer) {
						...
						Texture.drawShadedTriangle(i7, k7, anIntArray1679[3], j3, j5,
							...
							anIntArray1680[2], anIntArray1680[3], vertexPerspectiveZB[i1], vertexPerspectiveZB[j1], vertexPerspectiveZB[k1]);
					} else {
					Texture.method374(i7, j7, k7, j3, j4, j5,
							anIntArray1680[0], anIntArray1680[1],
							anIntArray1680[2]);
				...
				if (i8 == 1) {
					...
					if(Constants.enableDepthBuffer) {
						...
						Texture.drawFlatTriangle(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], l8, vertexPerspectiveZB[i1], vertexPerspectiveZB[j1], vertexPerspectiveZB[k1]);
					} else {
				...
				if (i8 == 2) {
					...
					if(Constants.enableDepthBuffer) {
						Texture.drawTexturedTriangle(i7, j7, k7, j3, j4, j5,
							...
							anIntArray1670[i12], anIntArray1640[i], vertexPerspectiveZB[i1], vertexPerspectiveZB[j1], vertexPerspectiveZB[k1]);
					} else {
					Texture.method378(i7, j7, k7, j3, j4, j5,
							anIntArray1680[0], anIntArray1680[1],
							anIntArray1680[2], anIntArray1668[i10],
				...
				if (i8 == 3) {
					...
					if(Constants.enableDepthBuffer) {
						Texture.drawTexturedTriangle(i7, j7, k7, j3, j4, j5,
								...
								anIntArray1670[j12], anIntArray1640[i], vertexPerspectiveZB[i1], vertexPerspectiveZB[j1], vertexPerspectiveZB[k1]);
						} else {
					Texture.method378(i7, j7, k7, j3, j4, j5,
							anIntArray1634[i], anIntArray1634[i],
							anIntArray1634[i], anIntArray1668[j10],
	...
	static boolean aBooleanArray1663[] = new boolean[9000];
	static boolean aBooleanArray1664[] = new boolean[9000];
	static int anIntArray1665[] = new int[9000];
	static int anIntArray1666[] = new int[9000];
	static int anIntArray1667[] = new int[9000];
	static int anIntArray1668[] = new int[9000];
	static int anIntArray1669[] = new int[9000];
	static int anIntArray1670[] = new int[9000];
	static int vertexPerspectiveZB[] = new int[9000];
